      ...
      <div className="relative z-10 px-4 md:px-12 lg:px-16 pt-4 md:pt-6">
        <nav className="liquid-glass rounded-xl px-3 md:px-4 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="https://wa.me/917375096163" target="_blank" rel="noopener noreferrer" className="hidden sm:inline-flex items-center gap-1.5 text-white px-4 md:px-6 py-2 rounded-lg text-sm font-medium transition-colors duration-200" style={{ background: '#25D366' }}>
        ...
        <div className="max-w-4xl">
          ...
          <FadeIn delay={1200} duration={1000}>
            <div className="flex flex-col sm:flex-row flex-wrap gap-3">
              <a href="#contact" className="text-center text-white px-7 py-3 rounded-lg font-medium btn-press border border-white/20" style={{ background: 'rgba(228,0,20,0.55)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}>Book Free Consultation</a>
              <a
                href="https://wa.me/917375096163"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white px-7 py-3 rounded-lg font-medium transition-all duration-200 flex items-center gap-2 border border-white/20"
                style={{ background: 'rgba(37,211,102,0.55)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}
              >
